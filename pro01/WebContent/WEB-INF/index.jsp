			...
			<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
			  <div class="carousel-inner">
			    <div class="carousel-item active">
			      <img src="${path0 }/imgs/vs7.png" class="d-block w-100" alt="...">
			    </div>
			    <div class="carousel-item">
			      <img src="${path0 }/imgs/vs5.png" class="d-block w-100" alt="...">
			    </div>
			    <div class="carousel-item">
			      <img src="${path0 }/imgs/vs6.png" class="d-block w-100" alt="...">
			    </div>
			  </div>
